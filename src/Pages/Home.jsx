      ...
      <div className="flex items-center justify-between px-[100px] gap-5">
        ...
        <div className="left w-[50%] h-[85vh] mt-5 bg-gray-800 rounded-lg">
          <div className="skeleton w-full h-full items-center flex flex-col justify-center">
            <div className="circle p-5 h-[100px] w-[100px] rounded-[50%] flex items-center justify-center text-2xl
            bg-linear-to-r from-purple-400  to-purple-600 "><HiOutlineCode/></div>
            <p className="text-[16px] text-gray-500 font-semibold mt-3">Code will generate here</p>
          </div>
        </div>
      </div>
    </>
